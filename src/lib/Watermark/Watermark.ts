import {
  ...
  WatermarkCanvas,
  type WatermarkBaseCoordinates,
  type WatermarkCoordinates,
  type Watermarked,
  type WatermarkImage,
  type WatermarkText,
} from "./WatermarkCanvas";
...
export class Watermark {
  ...
  private getCoordinates(isPortrait: boolean, coordinates: WatermarkCoordinates) {
  ...
  public async applyText({ text, coordinates, style, position }: WatermarkText) {
    const promise = new Promise((resolve, reject) => {
